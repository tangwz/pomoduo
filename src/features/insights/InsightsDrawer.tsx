...
export default function InsightsDrawer({
  ...
  return (
    <>
      <div
        className={`insights-overlay ${isOpen ? 'is-open' : ''}`}
        onClick={onClose}
        aria-hidden={!isOpen}
      />
      <aside
        className={`insights-drawer ${isOpen ? 'is-open' : ''}`}
        aria-hidden={!isOpen}
      >
        <header className="insights-header">
          ...
          <button
            ...
            aria-label={messages.insights.closeButtonLabel}
            onClick={onClose}
          >
            ×
          </button>
          ...
          <div className="insights-content">
            <section className="insights-section">
              ...
              <div className="insights-heatmap-wrap">
                ...
                <div className="insights-heatmap-grid" role="img" aria-label={messages.insights.heatmapTitle}>
